-- =============================================================================
-- 0108_license_entitlements.sql — Modelo de licencia en la base (Fase 1, §3).
-- =============================================================================
...
-- backfill (0109) y el candado (0110) son los que mueven el comportamiento.
--
-- Numeración: esta rama sale de main (última 0107). El motor de visión usa
-- 0108-0110 en OTRA rama que no llega a main; por eso aquí 0108+ es contiguo y
-- correcto para producción. (Ver nota de coordinación del sandbox en la entrega.)
-- =============================================================================
