        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 4,
              children: [
                legendDot(KuraTissueColors.granulacion, 'Granulación'),
                legendDot(KuraTissueColors.esfacelo, 'Esfacelo'),
                legendDot(KuraTissueColors.necrosis, 'Necrosis'),
                legendDot(KuraTissueColors.epitelizacion, 'Epitelización'),
              ],
            ),
            const SizedBox(height: 12),
            SizedBox(
              ...
              child: LineChart(
                LineChartData(
                  ...
                  betweenBarsData: [
                    BetweenBarsData(fromIndex: 0, toIndex: 1, color: KuraTissueColors.granulacion),
                    BetweenBarsData(fromIndex: 1, toIndex: 2, color: KuraTissueColors.esfacelo),
                    BetweenBarsData(fromIndex: 2, toIndex: 3, color: KuraTissueColors.necrosis),
                    BetweenBarsData(fromIndex: 3, toIndex: 4, color: KuraTissueColors.epitelizacion),
                  ],
                ),
              ),
            ),
